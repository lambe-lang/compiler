...
let should_substitute_in_variable () =
  ...
  and computed = Substitution.substitute [ "a", Variable "Int" ] (Variable "a") in
...
let should_not_substitute_in_variable () =
  ...
  and computed = Substitution.substitute [ "a", Variable "Int" ] (Variable "b") in
...
let should_substitute_in_apply () =
  ...
  and computed =
    Substitution.substitute [ "a", Variable "String" ] (Apply (Variable "Int", Variable "a"))
  in
